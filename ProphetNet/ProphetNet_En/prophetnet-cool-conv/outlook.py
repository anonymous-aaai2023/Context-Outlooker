...
class OutlookAttention(nn.Module):
    ...
    def __init__(self, dim, num_heads, kernel_size=(3,1024), padding=1, stride=(2,1024),
...
class Outlooker(nn.Module):
    ...
    """
    def __init__(self, dim, kernel_size=(3,1024), padding=1, stride=(2,1024),
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None,
                 out_features=None, act_layer=None,
                 drop=0.):
        super().__init__()

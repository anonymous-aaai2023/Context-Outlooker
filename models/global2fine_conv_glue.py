...
class Global2Fine_Sentence_Classification(nn.Module):
    ...
    def __init__(self, model_name_or_path, num_labels, task_name="",config_name="", cache_dir="", embed_dims=768, seq_len = 384, num_layers=4, \
